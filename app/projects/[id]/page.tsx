        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="space-y-8 lg:col-span-2">
            ...
            <div className="border-border/60 bg-card/60 rounded-3xl border p-8 shadow-sm backdrop-blur-xs">
              <h2 className="font-heading mb-4 text-2xl font-bold tracking-tight">About the Project</h2>
              ...
              {project.features && project.features.length > 0 && (
                <div className="mt-8 border-t border-border/50 pt-6">
                  <h3 className="font-heading mb-4 text-lg font-bold tracking-tight">Key Features</h3>
                  <ul className="space-y-3">
                    {project.features.map((feature, i) => (
                      ...
                      >
                        <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#0CBAA6]/15 text-[#0CBAA6] mt-0.5">
          ...
          <div className="space-y-8">
            <div className="border-border/60 bg-card/60 rounded-3xl border p-7 shadow-sm backdrop-blur-md">
              <h3 className="font-heading mb-6 text-xl font-bold tracking-tight">Project Overview</h3>
                      ...
                      <ul className="space-y-2">
                        {project.team.map((m, idx) => (
                          <li key={idx} className="flex items-center gap-2.5">
                            <span className="bg-[#0CBAA6]/10 text-[#0CBAA6] flex h-7 w-7 items-center justify-center rounded-full text-xs font-bold">
                              {m[0]}
                            </span>
                            <span className="text-foreground text-sm font-semibold">{m}</span>
                          </li>
                        ))}
                      </ul>
                    ) : (
                      <span className="text-foreground text-sm font-semibold">{project.author}</span>
                    )}
                  </div>
                </div>
            ...
            {project.demoUrl && (
              <div className="rounded-3xl border border-[#0CBAA6]/30 bg-[#0CBAA6]/5 p-7 backdrop-blur-xs">
                <h4 className="font-heading font-bold text-[#0CBAA6] text-lg">
