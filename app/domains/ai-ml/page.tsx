...
const SYLLABUS = [
  { module: "Module 1", desc: "Python & Data Math", icon: BookOpen },
  { module: "Module 2", desc: "Machine Learning Algorithms", icon: Lightbulb },
  { module: "Module 3", desc: "Deep Learning & Neural Nets", icon: Users },
  { module: "Module 4", desc: "AI in Production", icon: Award },
];
          ...
          <div className="space-y-12 lg:col-span-2">
            <section>
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                Dive deep into AI & Machine Learning. Our curriculum is designed
                to take you from fundamentals to advanced concepts, preparing
